...
INSERT INTO EMPLOYEE(Fname,Minit,Lname,Ssn,Bdate,e_Address,Sex,Salary,Super_ssn,Dno)VALUES('Paula','A','Sousa',183623612,'2001-08-11','Rua da FRENTE','F',1450.00,NULL,3)
INSERT INTO EMPLOYEE(Fname,Minit,Lname,Ssn,Bdate,e_Address,Sex,Salary,Super_ssn,Dno)VALUES('Carlos','D','Gomes',21312332,'2000-01-01','Rua XPTO','M',1200.00,NULL,1)
INSERT INTO EMPLOYEE(Fname,Minit,Lname,Ssn,Bdate,e_Address,Sex,Salary,Super_ssn,Dno)VALUES('Juliana','A','Amaral',321233765,'1980-08-11','Rua BZZZZ','F',1350.00,NULL,3)
INSERT INTO EMPLOYEE(Fname,Minit,Lname,Ssn,Bdate,e_Address,Sex,Salary,Super_ssn,Dno)VALUES('Maria','I','Pereira',342343434,'2001-05-01','Rua JANOTA','F',1250.00,21312332,2)
INSERT INTO EMPLOYEE(Fname,Minit,Lname,Ssn,Bdate,e_Address,Sex,Salary,Super_ssn,Dno)VALUES('Joao','G','Costa',41124234,'2001-01-01','Rua YGZ','M',1300.00,21312332,2)
INSERT INTO EMPLOYEE(Fname,Minit,Lname,Ssn,Bdate,e_Address,Sex,Salary,Super_ssn,Dno)VALUES('Ana','L','Silva',12652121,'1990-03-03','Rua ZIG ZAG','F',1400.00,21312332,2)
