...
As entidades e seus atributos são 
 ...
 - Tipo de fornecedor: 1.Código interno;
                       2.Designação.

Relações:
    1 Empresa -> Comercializa -> 1 Produto
    1 Empresa -> Faz -> N Encomendas
    N Encomendas -> Possuem uma respetiva quantidade -> N Produtos
    1 Fornecedor -> Recebe -> N Encomendas
    N Fornecedores -> São -> 1 Tipo de Fornecedor
...
1ª Relação:
    ...
    GRAU: 2; Binária
    CARDINALIDADE: 1:1
    OBRIGATORIEDADE: Obrigatório 1 Produto ser comercializado por 1 Empresa. Não é obrigatório 1 Empresa comercializar 1 Produto.

2ª Relação:
    1 Empresa -> Faz -> N Encomendas
    GRAU: 2; Binária
    CARDINALIDADE: 1:N
    OBRIGATORIEDADE: Não é obrigatório as instâncias das entidades participarem no relacionamento.

3ª Relação:
    N Encomendas -> Possuem uma respetiva quantidade -> M Produtos
    GRAU: 2; Binária
    CARDINALIDADE: N:M
    OBRIGATORIEDADE: É obrigatório ambas as instâncias das entidades participarem no relacionamento.

4ª Relação:
    1 Fornecedor -> Recebe -> N Encomendas
    GRAU: 2; Binária
    CARDINALIDADE: 1:N
    OBRIGATORIEDADE: Não é obrigatório 1 Fornecedor receber as encomendas. É obrigatório todas as encomendas serem recebidas por 1 Fornecedor.

5ª Relação:
    N Fornecedores -> São -> 1 Tipo de Fornecedor
    GRAU: 2; Binária
    CARDINALIDADE: N:1
    OBRIGATORIEDADE: É obrigatório todos os fornecedores terem um tipo. Não é obrigatório que 1 tipo seja de todos os fornecedores.
